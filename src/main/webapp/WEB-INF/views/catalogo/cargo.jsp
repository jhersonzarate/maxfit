                    ...
                    <form action="${pageContext.request.contextPath}/cargo"
                        ...
                        <div style="padding:1.35rem 1.5rem; display:flex; flex-direction:column; gap:1rem;">
                            <div class="form-section-divider">
                                <span class="form-section-divider__label">Datos del cargo</span>
                            </div>
                            <div class="form-row">
                                <div class="form-field">
                                    <label for="nombreCargo">
                                        Nombre del cargo <span class="required-star">*</span>
                                    </label>
                                    <input type="text" id="nombreCargo" name="nombre"
                                           class="form-control"
                                           placeholder="Ej: Nutricionista, Coordinador"
                                           maxlength="50" required
                                           value="<c:out value='${entidad.nombre}'/>">
                                    <span class="form-field__hint">
                                        Determina el acceso del empleado al sistema
                                    </span>
                                </div>
                                <div class="form-field">
                                    <label for="estado-cg">Estado</label>
                                    <select id="estado-cg" name="estado" class="form-control">
                                        <option value="activo"
                            ...
                            <div class="module-alert module-alert--warning" style="margin-bottom:0;">
                                ...
                                <div class="module-alert__body">
                                    <p class="module-alert__text">
                                        Los cargos <strong>Administrador, Recepcionista e Instructor</strong>
                                        están ligados al control de acceso del sistema.
                                        Modifica solo si sabes el impacto que tiene.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-card__footer">
                            <button type="submit" class="btn btn-primary">
                                ...
                                ${modoEdicion ? 'Guardar cambios' : 'Crear cargo'}
                            </button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="cell-actions">
                                                    <a href="${pageContext.request.contextPath}/cargo?action=edit&id=<c:out value='${cg.id}'/>"
