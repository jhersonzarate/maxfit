<%--============================================================clients.jsp — MaxFit Sistema de Gestión Módulo de
    gestión de clientes. Servlet: ClientsController.java → GET/POST /clients Acceso: ROL-ADMIN | ROL-RECEP (RoleFilter)
    ── Parámetros de URL que activan vistas ────────────────── /clients → lista de clientes (default) /clients?form=true
    → formulario nuevo / edición /clients?action=view&id=... → redirige a client-detail.jsp ── Atributos de request
    ───────────────────────────────── Vista lista (default): clientes (List<Cliente>) → todos o filtrados
                            ...
                            <%@ include file="/WEB-INF/views/includes/head-common.jsp" %>
                                <c:choose>
                                    <c:when test="${param.form eq 'true'}">
                                        <c:set var="pageTitle"
                                            value="${modoEdicion ? 'Editar Cliente' : 'Nuevo Cliente'}"
                                            scope="request" />
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <%@ include file="/WEB-INF/views/includes/sidebar.jsp" %>
                                    ...
                                    <div class="app-main">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:set var="pageTitle" value="Clientes" scope="request" />
                                                <c:set var="pageSubtitle" value="Gestión del padrón de socios"
                                                    scope="request" />
                                            </c:otherwise>
                                        </c:choose>
                                        <%@ include file="/WEB-INF/views/includes/navbar.jsp" %>
                                                            ...
                                                            <c:when test="${param.form eq 'true'}">
                                                                ...
                                                                <%-- Breadcrumb --%>
                                                                    <nav class="module-breadcrumb"
                                                                        ...
                                                                        <a
                                                                            href="${pageContext.request.contextPath}/clients">Clientes</a>
                                                                                ...
                                                                                <h1 class="module-header__title">
                                                                                    <c:choose>
                                                                                        <c:when test="${modoEdicion}">
                                                                                            Editar Cliente</c:when>
                                                                                        <c:otherwise>Registrar Cliente
                                                                                        </c:otherwise>
                                                                                    </c:choose>
                                                                                </h1>
                                                                                <div class="module-header__meta">
                                                                                    <span>Completa los datos del
                                                                                        socio</span>
                                                                                    <span
                                                                                        class="module-header__meta-sep"></span>
                                                                                    <span>Los campos marcados con * son
                                                                                        obligatorios</span>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <c:if test="${not empty formError}">
                                                                                <div class="module-alert module-alert--error"
                                                                                    ...
                                                                                    <svg class="module-alert__icon"
                                                                                        ...
                                                                                        stroke-width="2">
                                                                                        <path stroke-linecap="round"
                                                                                            stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73
                                         0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898
                                         0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
                                                                                    </svg>
                                                                                    <div class="module-alert__body">
                                                                                        <p class="module-alert__title">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <%-- Sección: Datos
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <span
                                                                                                            class="form-section-divider__label">Datos
                                                                                                            personales</span>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <%-- Sección:
                                                                                                        ...
                                                                                                        <%-- Sección:
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="form-section-divider">
                                                                                                                <span
                                                                                                                    class="form-section-divider__label">Información
                                                                                                                    de
                                                                                                                    contacto</span>
                                                                                                            </div>
                                                                                                                    ...
                                                                                                                    <%-- Teléfono
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <input
                                                                                                                                ...
                                                                                                                                title="Ingrese un télefono peruano (9XXXXXXXX) o un número internacional (+...)"
                                                                    ...
                                                                    <%-- Header del módulo --%>
                                                                        <div class="module-header">
                                                                            <div class="module-header__left">
                                                                                ...
                                                                                <div class="module-header__meta">
                                                                                    <span>Padrón completo de socios
                                                                                        registrados</span>
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <div class="toolbar-search">
                                                                                    <svg class="toolbar-search__icon"
                                                                                        ...
                                                                                        stroke-width="1.8">
                                                                                        <path stroke-linecap="round"
                                                                                            stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196
                                         5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                                                                                    ...
                                                                                    <button type="submit"
                                                                                        class="toolbar-search__btn">Buscar</button>
                                                                                </div>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <%-- Color
                                                                                                                            ...
                                                                                                                            <c:set
                                                                                                                                var="avIdx"
                                                                                                                                value="${loop.index mod 5}" />
                                                                                                                            <div
                                                                                                                                class="cell-name__avatar ${fn:split(avColors, ',')[avIdx]}">
                                                                                                                                <c:out
                                                                                                                                    value="${fn:substring(cli.nombre, 0, 1)}" />
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                                ...
                                                                                                                <%-- Documento
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <div
                                                                                                                            class="cell-data">
                                                                                                                            <span
                                                                                                                                class="cell-data__main">
                                                                                                                                <c:out
                                                                                                                                    value="${cli.numeroDocumento}" />
                                                                                                                            </span>
                                                                                                                            <span
                                                                                                                                class="cell-data__sub">
                                                                                                                                <c:if
                                                                                                                                    test="${cli.tipoDocumento != null}">
                                                                                                                                    <c:out
                                                                                                                                        value="${cli.tipoDocumento.abreviado}" />
                                                                                                                                </c:if>
                                                                                                                            </span>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                    ...
                                                                                                                    <%-- Contacto
                                                                                                                        ...
                                                                                                                        <td>
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <c:choose>
                                                                                                                                    ...
                                                                                                                                    <c:otherwise>
                                                                                                                                        <span
                                                                                                                                            class="cell-data__sub">Sin
                                                                                                                                            email</span>
                                                                                                                                    </c:otherwise>
                                                                                                                                </c:choose>
                                                                                                                                <c:if
                                                                                                                                    test="${not empty cli.telefono}">
                                                                                                                                    <span
                                                                                                                                        class="cell-data__sub">
                                                                                                                                        <c:out
                                                                                                                                            value="${cli.telefono}" />
                                                                                                                        ...
                                                                                                                        <%-- Género
                                                                                                                            ...
                                                                                                                            <td>
                                                                                                                                <c:choose>
                                                                                                                                    <c:when
                                                                                                                                        test="${cli.genero eq 'Masculino'}">
                                                                                                                                        <span
                                                                                                                                            class="badge-estado badge-estado--activo">M</span>
                                                                                                                                    </c:when>
                                                                                                                                    <c:when
                                                                                                                                        test="${cli.genero eq 'Femenino'}">
                                                                                                                                        <span
                                                                                                                                            class="badge-estado badge-estado--pago-activo">F</span>
                                                                                                                                    </c:when>
                                                                                                                                    <c:when
                                                                                                                                        test="${not empty cli.genero}">
                                                                                                                                        <span
                                                                                                                                            class="badge-estado badge-estado--pendiente">
                                                                                                                                            <c:out
                                                                                                                                                value="${cli.genero}" />
                                                                                                                                        </span>
                                                                                                                                    </c:when>
                                                                         ...
                                                                         1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
                                                                                                                                                ...
                                                                                                                                                <%-- Editar
                                                                                                                                                    ...
                                                                                                                                                    --%>
                                                                                                                                                    <c:if
                                                                                                                                                        test="${sessionScope.userRole eq 'ROL-ADMIN'}">
                                            ...
                                            background:rgba(255,255,255,0.012);">
                                                                                                    <span
                                                                                                        ...
                                                                                                        cliente<c:if
                                                                                                            test="${totalClientes ne 1}">
                                                                                                            s</c:if>
                                                                                                        <c:if
                                                                                                            test="${not empty query}">
                                                                                                            para "
                                                                                                            <c:out
                                                                                                                value='${query}' />
                                                                                                            "
