                            ...
                            <div class="contrato-detail-hero">
                                <div class="contrato-detail-hero__top">
                                    ...
                                    <div style="display:flex; align-items:center; gap:0.65rem; flex-shrink:0;">
                                        ...
                                        <a href="${pageContext.request.contextPath}/contracts?action=boleta&id=<c:out value='${contrato.id}'/>"
                                           class="btn btn-primary btn-sm"
                                           target="_blank"
                                           title="Ver boleta del contrato">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="cell-actions">
                                                        ...
                                                        <%-- Ver boleta del contrato --%>
                                                        <a href="${pageContext.request.contextPath}/contracts?action=boleta&id=<c:out value='${con.id}'/>"
                                                           class="btn btn-ghost btn-sm btn-icon"
                                                           target="_blank"
                                                           title="Ver boleta">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
