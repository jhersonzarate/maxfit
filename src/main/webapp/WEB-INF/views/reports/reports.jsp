<%--============================================================reports.jsp — MaxFit Sistema de Gestión Reportes
    globales del sistema (solo ROL-ADMIN). Servlet: ReportsController.java → GET /reports Acceso: Solo ROL-ADMIN
    (RoleFilter) ── Parámetros de URL que activan vistas ────────────────── /reports → reporte resumen (default)
    /reports?action=contratos → reporte de contratos por estado /reports?action=asistencia → reporte de asistencia
    /reports?action=membresias → reporte de membresías activas ── Atributos comunes a todas las vistas ─────────────────
    vistaActiva (String) → "resumen" |"contratos"|"asistencia"|"membresias" fechaReporte (String ISO) → fecha actual del
    reporte ── Vista resumen (default) ────────────────────────────── totalClientes (int / "-" ) contratosActivos (int
    / "-" ) atendidosHoy (int / "-" ) totalEmpleados (int / "-" ) clasesVigentes (int / "-" ) ingresosMes (BigDecimal)
    ...
    asistenciasRecientes (List<Asistencia>) ← últimas 10
        ...
        proximosVencer (List<Contrato>)
           ...
           ══════════════════════════════════════════════════════ */
                                                    ...
                                                    .report-kpi-card:hover::before {
                                                        transform: scaleX(1);
                                                    }

                                                    /* Variantes de color */
                                                    .report-kpi-card.c--red {
                                                        --kpi-c: var(--clr-red);
                                                    }

                                                    .report-kpi-card.c--green {
                                                        --kpi-c: var(--clr-success);
                                                    }

                                                    .report-kpi-card.c--blue {
                                                        --kpi-c: var(--clr-info);
                                                    }

                                                    .report-kpi-card.c--yellow {
                                                        --kpi-c: var(--clr-warning);
                                                    }

                                                    .report-kpi-card.c--purple {
                                                        --kpi-c: #a78bfa;
                                                    }

                                                    .report-kpi-card.c--teal {
                                                        --kpi-c: #2dd4bf;
                                                    }
                                                    ...
                                                    .report-kpi-card:nth-child(5) {
                                                        animation-delay: 0.20s;
                                                    }

                                                    .report-kpi-card:nth-child(6) {
                                                    ...
                                                    .report-card__icon.green-icon svg {
                                                    ...
                                                    .report-card__icon.blue-icon svg {
                                                        color: var(--clr-info);
                                                    }
                                                    ...
                                                    .report-card__icon.yellow-icon svg {
                                                    ...
                                                    .donut-chart__seg--activos {
                                                        stroke: var(--clr-success);
                                                    }

                                                    .donut-chart__seg--vencidos {
                                                        stroke: var(--clr-red);
                                                    }

                                                    .donut-chart__seg--cancelados {
                                                    ...
                                                    .donut-legend-dot--activos {
                                                        background: var(--clr-success);
                                                    }

                                                    .donut-legend-dot--vencidos {
                                                        background: var(--clr-red);
                                                    }

                                                    .donut-legend-dot--cancelados {
                                                    ...
                                                    .attendance-row__dot.falto {
                                                        background: var(--clr-text-dim);
                                                    }

                                                    .attendance-row__dot.pendiente {
                                                    ...
                                                    .membresia-report-row:last-child {
                                                        border-bottom: none;
                                                    }

                                                    .membresia-report-row:hover {
                                                        background: rgba(255, 255, 255, 0.025);
                                                    }
                                                    ...
                                                    .contrato-compact-row:last-child {
                                                        border-bottom: none;
                                                    }

                                                    .contrato-compact-row:hover {
                                                    ...
                                                    .ingresos-highlight::after {
                                                        ...
                                                        width: 160px;
                                                        height: 160px;
                                                        background: radial-gradient(circle, var(--clr-surface-2) 0%, transparent 70%);
                                                        pointer-events: none;
                                                    }
                                        ...
                                        <body>
                                            ...
                                            <div class="app-shell">
                                                <%@ include file="/WEB-INF/views/includes/sidebar.jsp" %>
                                                    ...
                                                    <div class="app-main">
                                                        ...
                                                        <c:set var="pageTitle" value="Reportes" scope="request" />
                                                        <c:set var="pageSubtitle" value="Panel analítico del sistema"
                                                            scope="request" />
                                                                    ...
                                                                    <div class="module-header"
                                                                        ...
                                                                        <div class="module-header__left">
                                                                            <div class="report-section-header">
                                                                                <div
                                                                                    class="report-section-header__icon">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        fill="none" viewBox="0 0 24 24"
                                                                                        stroke="currentColor"
                                                                                        stroke-width="1.8">
                                                                                        <path stroke-linecap="round"
                                                                                            stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504
                                         ...
                                         1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
                                                                                ...
                                                                                <div
                                                                                    class="report-section-header__info">
                                                                                    <h1
                                                                                        class="report-section-header__title">
                                                                                        Reportes del Sistema
                                                                                    </h1>
                                                                                    <p
                                                                                        class="report-section-header__sub">
                                                                                        Datos en tiempo real — generado
                                                                                        el
                                                                                        <strong
                                                                        ...
                                                                        <div class="module-header__actions">
                                                                            <span class="report-date-badge">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    ...
                                                                                    stroke-width="2">
                                                                                    <path stroke-linecap="round"
                                                                                        stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25
                                                                            ...
                                                                            <%-- Resumen --%>
                                                                                <a href="${pageContext.request.contextPath}/reports"
                                                                                    ...
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        ...
                                                                                        stroke-width="1.8">
                                                                                        <path stroke-linecap="round"
                                                                                            stroke-linejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25
                                 ...
                                 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                                                 ...
                                                 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75" />
                                                    ...
                                                    font-size:0.73rem; color:var(--clr-text-dim);">
                                                                                    ...
                                                                                    <%-- ──────────────────────────────────────────
                                                                                        ...
                                                                                        --%>
                                                                                        <c:when
                                                                                            test="${vistaActiva eq 'asistencia'}">
                                                                                                ...
                                                                                                <div class="report-kpi-grid"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="report-kpi-card__header">
                                                                                                            <span
                                                                                                                class="report-kpi-card__label">Atendidos
                                                                                                                hoy</span>
                                                                                                            <div
                                                                                                                class="report-kpi-card__badge">
                                                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            class="report-kpi-card__header">
                                                                                                            <span
                                                                                                                class="report-kpi-card__label">Más
                                                                                                                reciente</span>
                                                                                                            <div
                                                                                                                class="report-kpi-card__badge">
                                                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                display:flex; align-items:center; justify-content:space-between;">
                                                                                                            ...
                                                                                                            <%-- Total
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="report-kpi-card__header">
                                                                                                                        <span
                                                                                                                            class="report-kpi-card__label">Clientes</span>
                                                                                                                        <div
                                                                                                                            class="report-kpi-card__badge">
                                                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                                fill="none"
                                                 ...
                                                 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5" />
                                                                                                                        ...
                                                                                                                        <%-- Total
                                                                                                                            ...
                                                                                                                            --%>
                                                                                                                            <div
                                                                                                                                class="report-kpi-card c--purple">
                                                                                                                                <div
                                                                                                                                    class="report-kpi-card__header">
                                                                                                                                    <span
                                                                                                                                        class="report-kpi-card__label">Empleados</span>
                                                                                                                                    <div
                                                                                                                                        class="report-kpi-card__badge">
                                                                                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                                            fill="none"
                                                                                                                            ...
                                                                                                                            <%-- Clases
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                        class="report-kpi-card__header">
                                                                                                                                        <span
                                                                                                                                            class="report-kpi-card__label">Clases
                                                                                                                                            activas</span>
                                                                                                                                        <div
                                                                                                                                            class="report-kpi-card__badge">
                                                                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                                ...
                                                                                                                                <%-- Ingresos
                                                                                                                                    ...
                                                                                                                                    <div class="report-kpi-card c--red"
                                                                                                                                        style="border-color:rgba(230,48,39,0.15);">
                                                                                                                                        <div
                                                                                                                                            class="report-kpi-card__header">
                                                                                                                                            <span
                                                                                                                                                class="report-kpi-card__label">Ingresos
                                                                                                                        ...
                                                                                                                        <div
                                                                                                                            ...
                                                                                                                            <div
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        class="report-card__title">Actividad
                                                                                                                                        reciente</span>
                                                                                                                                </div>
                                                                                                                                <div
                                                ...
                                                display:flex; align-items:center; justify-content:space-between;">
                                                                                                                                        <span
                                                                                                                                            style="font-size:0.73rem; color:var(--clr-text-dim);">
                                                                                                                                            Últimas
                                                                                                                                            <strong
                                                                                                                                                style="color:var(--clr-text-muted);">
                                                                                                                                                <c:out
                                                                                                                                                    value="${fn:length(asistenciasRecientes)}" />
                                                                                                                                            </strong>
                                                                                                                                            asistencias
                                                                                                                                        </span>
                                                                                                                                        <a href="${pageContext.request.contextPath}/reports?action=asistencia"
                                                                                                                                            ...
                                                                                                                                            <div
                                                                                                                                                ...
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <div
                                                                                                                                                        class="report-card__header-left">
                                                                                                                                                        <div
                                                                                                                                                            class="report-card__icon blue-icon">
                                                                                                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                                                                                                                fill="none"
                                                                                                                                                                viewBox="0 0 24 24"
                                                                                                                                                                stroke="currentColor"
                                                                                                                                                        ...
                                                                                                                                                        <span
                                                                                                                                                            class="report-card__title">Accesos
                                                                                                                                                            rápidos</span>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                                <div
                                                                                                                                                    style="padding:1rem 1.25rem; display:flex; flex-direction:column; gap:0.5rem;">
                                                                                                                                                    <a href="${pageContext.request.contextPath}/reports?action=contratos"
